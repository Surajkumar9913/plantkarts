	    ...
	    <span class="navbar-toggler-icon"></span>
           ...
           <%
                  String email1=null;
                   ...
                   PlantOrderAction acc=new PlantOrderAction();
                   int i=acc.orderInKart(email1);
	   ...
	   <div id="menu" class="navbar-collapse collapse">
	     <ul class="nav navbar-nav">
		    ...
		    <li class="nav-item"><a href="#" class="nav-link">About Us</a></li>
                    ...
                    <li><a href="payment.jsp"><img src="img/cart.png"><span style="font-weight: 800;font-size: 20px; color: white;"><sub><%=i%></sub></span></a></li>
